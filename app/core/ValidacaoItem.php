...
class ValidacaoItem
{
    ...
    public function isVazioCnpj($msg = null, $erro = Validacao::ERRO_CPFCNPJ)
    {

        $msg = "O campo " . $this->campo . " numeros informados CPF/CNPJ invalidos.";
    ...
    public function isArquivo($msg = null, $erro = Validacao::ERRO_ARQUIVO)
    {
        $valor = trim($this->valor, " \n\t\r");
        if (!strlen($valor) > 0) {
            if ($msg == null) {
