...
class Service
{
    ...
    public static  function getSoma2($tabela, $campAgregacao, $campo = null,  $valor = null)
    {
        $dao = new Dao();
        $valor =  $dao->getSoma2($tabela, $campAgregacao, $campo,  $valor)->soma;
        return $valor ? $valor : 0;
    }
    public static  function getCompensado($tabela, $campoAgregacao, $campo, $valor, $id_corretora)
    {
        $dao = new Dao();
        return  $dao->getCompensado($tabela, $campoAgregacao, $campo, $valor, $id_corretora);
    }
    public static  function getCredito($tabela, $campoAgregacao, $campo, $valor, $id_corretora)
    {
        $dao = new Dao();
        return  $dao->getCredito($tabela, $campoAgregacao, $campo, $valor, $id_corretora);
    }
    public static  function getDebito($tabela, $campoAgregacao, $campo, $valor, $id_corretora)
    {
        $dao = new Dao();
        return  $dao->getDebito($tabela, $campoAgregacao, $campo, $valor, $id_corretora);
    }
    public static  function getAcompensar($tabela, $campoAgregacao, $campo, $valor, $id_corretora)
    {
        $dao = new Dao();
        return  $dao->getAcompensar($tabela, $campoAgregacao, $campo, $valor, $id_corretora);
    }
    public static function listaCorr($tabela, $id_corretora)
    {
        $dao = new Dao();
        return $dao->listaCorr($tabela, $id_corretora);
    }
    public static  function getLikeC($tabela, $campo, $valor, $id_corretora, $eh_lista = false, $posicao = null)
    {
        $dao = new Dao();
        return  $dao->getLikeC($tabela, $campo, $valor, $id_corretora, $eh_lista, $posicao);
    }
    ...
    public static  function getMinimo2($tabela, $campAgregacao, $campo = null,  $valor = null)
    {
        $dao = new Dao();
        return  $dao->getMinimo2($tabela,  $campAgregacao, $campo,  $valor)->min;
    }
    ...
    public static function logar($campo, $valor, $senha, $tabela)
    {
        ...
        if ($resultado) {
            if ($resultado->senha == $senha) {
                ...
                $resultadocli = $dao->get("cliente", "id_cliente", $resultado->id_cliente, false);
                $_SESSION['CLIENTE'] = $resultadocli;
                return true;
            }
        }
    ...
    public static function excluiritem($tabela, $campo, $valor, $valor2 = null)
    {
        $dao = new Dao();
        $excluir = $dao->excluiritem($tabela, $campo, $valor, $valor2);
        if ($excluir) {
            Flash::setMsg("Registro Exluído com Sucesso !");
        } else {
            Flash::setMsg("Não foi possível excluir o registro", -1);
