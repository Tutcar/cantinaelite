        ...
        <div>
            <div class="text-end d-flex">
                ...
                <?php if ($idAbre == 0) : ?>
                    <p><?php $this->verMsg(); ?> </p>
                <?php elseif ($idAbre > 0) : ?>
                    <a title="Fechar caixa" href="<?php echo URL_BASE . "Caixafecha/createnaoconferido/" . $idAbre ?>" class="d-inline-block mb-2"><img style="width: 35px; height: 35px" src="<?php echo URL_IMAGEM . "cadastro.jpeg"; ?>"></a>
                <?php endif; ?>
            </div>
        </div>
        <?php $this->verMsg() ?>
    ...
    <div class="base-lista">
        <?php foreach ($cxfuncionarios as $funcionario) { ?>
            <div class="tabela-responsiva">
                ...
                <div class="text-end d-flex">
                    <a title="Ver resumo" href="<?php echo URL_BASE . "Caixafecha/caixaFuncionariosNaoConferido/$funcionario->id_user" . "/" .  $idAbre ?>" class="d-inline-block mb-2"><img style="width: 35px; height: 35px" src="<?php echo URL_IMAGEM . "cadastro.jpeg"; ?>"></a>
                </div>
            </div>
        <?php } ?>
    </div>
