                ...
                <tbody>
                    ...
                    <?php foreach ($lista as $compromisso) { ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href="javascript:;" onclick="pedidoEntregue(this)" data-entidade="compromisso" data-id="<?php echo $compromisso->id_compromisso ?>"><img style="width: 25px; height: 25px" src="<?php echo URL_IMAGEM . "editar.jpeg"; ?>"></a>
