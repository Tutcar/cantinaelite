                ...
                <tbody>
                    ...
                    <?php foreach ($lista as $relatorios) { ?>
                        <tr>
                            ...
                            <td align="center">
                                <a title="Verificar" href="<?php echo URL_BASE . "Relatorios/relatDia/" . $relatorios->id_caixaabre ?>">&nbsp;&nbsp;<img style="width: 30px; height: 30px" src="<?php echo URL_IMAGEM . "lupa.png"; ?>"></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
