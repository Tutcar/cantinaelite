$(function () {
    ...
    $('input[name=small]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Insira o valor do próximo small" });
    ...
    $('input[name=divisao_entre]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Insira o valor da divisão" });
    ...
    $('input[name=salario]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Valor sal��rio" });
    $('input[name=sl_comissao]').mask('00,00', { reverse: true, placeholder: "Percentual comiss�0�0o" });
    $('input[name=ac_valor]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Valor acr��scimo" });
    $('input[name=db_valor]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Valor d��bito" });
    ...
    $('input[name=diferenca]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Diferença caixa" });
    $('input[name=currency_cartao]').mask('000.000.000.000.000,00', { reverse: true, placeholder: "Valor do Credito" });
